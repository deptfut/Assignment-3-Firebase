...
class _CreatPostState extends State<CreatPost> {
  ...
  uploadImage(String key, OnFileDone onDone){
    FirebaseStorage.instance
        .ref().child(key + ".jpg").putFile(image).events.listen((event){
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        contentPadding: const EdgeInsets.only(top: 0, right: 16, left: 16),
                        hintStyle: TextStyle(
                  ...
                  Container(
                    ...
                    child: InkWell(
                      child: Row(
                        children: <Widget>[
                          Image.asset("assets/images/photo-of-a-landscape.png", height: 20, width: 25),
                          Padding(
                              padding: EdgeInsets.only(left: 11.06),
                              child: Text("Add Picture", style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 12,
                                  fontFamily: 'Nunito'
                              )
                  ...
                  Container(
                    child: image != null ? Image.file(image, fit: BoxFit.cover, height: 216, width: 418,) : Container(),
                  )
                ]
              )
            ),
            Padding(
              padding: EdgeInsets.only(top: 0, right: 42, bottom: 35, left: 42),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  RaisedButton(
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6.0)),
                    padding: EdgeInsets.only(top: 13, right: 24, bottom: 13, left: 23),
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Icon(Icons.done, color: Colors.white, size: 27)
                      ]
                    )
                  )
                ]
